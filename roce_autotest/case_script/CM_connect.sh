...
function CM_connect()
{
	...
	Cm_Client_Flag=`ssh root@${BACK_IP} " cd /root/${CASEPATH}/; ./cm-client -i $ROCE_PORT ${local_port_ip[$ROCE_PORT]} > ../${FUNCTION}_client.log; cd ../; grep -c 'pass: 2' ${FUNCTION}_client.log " `
	wait
